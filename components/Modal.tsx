            ...
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
                ...
                >
                    <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                        <Dialog.Title className="text-lg font-medium leading-6 text-gray-900 pb-2" as="h3">
                            Add a Task
                        ...
                        <div className='mt-2'>
                          ...
                          className='w-full border border-gray-300 rounded-md outline-none p-5 focus-within:ring-2
                          ...
                          {image && (
                            <Image 
                              ...
                              width={200}
                              height={200}
                              className='w-full h-full object-cover mt-2 filter hover:grayscale 
